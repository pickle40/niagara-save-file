...
<div class="row page-title-header">
    <div class="col-12">
        <div class="page-header d-flex justify-content-between align-items-center">
            <h4 class="page-title"> List File Tersimpan</h4>
            <div class="d-flex justify-content-start">
                ...
                <button type="button" class="btn btn-success" onclick="location.href='{{ url('save-file/add') }}'"><i class="mdi mdi-upload"></i>File</button>
            </div>
        </div>
