...
<div class="row page-title-header">
    <div class="col-12">
        <div class="page-header d-flex justify-content-between align-items-center">
            <h4 class="page-title"> List File Gambar Tersimpan</h4>
            <div class="d-flex justify-content-start">
                <!-- <button type="button" class="btn btn-warning" onclick="location.href='{{ url('po-bahanbaku/history') }}'" style="margin-right: 10px;"><i class="mdi mdi-history"></i>History Penerimaan PO Bahan Baku</button> -->
                <!-- <button type="button" class="btn btn-success" onclick="location.href='{{ url('po-bahanbaku/add') }}'"><i class="mdi mdi-plus"></i> Purchase Order Bahan Baku</button> -->
                <!-- {{-- <a href="{{ url('po-botol/add')}}" class="btn btn-icons btn-inverse-primary btn-new ml-2">
                    <i class="mdi mdi-plus"></i> Purchase Order Botol
                </a> --}} -->
                <button type="button" class="btn btn-success" onclick="location.href='{{ url('save-file-gambar/add') }}'"><i class="mdi mdi-upload"></i>File</button>
            </div>
        </div>
