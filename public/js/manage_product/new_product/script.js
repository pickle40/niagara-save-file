...
$(function () {
  $("form[name='create_form']").validate({
    rules: {
      ...
      master_kemasan: "required",
      pack: "required",
      berat_barang: "required",
      harga_modal_dos: "required",
      harga_modal_pack: "required",
      harga_jual_dos: "required",
    ...
    messages: {
      ...
      master_kemasan: "Silakan pilih jenis barang",
      pack: "Tidak boleh kosong",
      berat_barang: "Berat barang tidak boleh kosong",
      harga_modal_dos: "Harga modal barang (Dos) tidak boleh kosong",
      harga_modal_pack: "Harga modal barang (Pack) tidak boleh kosong",
      harga_jual_dos: "Harga jual barang tidak (Dos) boleh kosong",
      harga_jual_pack: "Harga jual barang tidak (Pack) boleh kosong",
      status_pajak: "Status pajak tidak boleh kosong"
    },
